...
class DataHandler:
	def __init__(self):
		if args.data == 'jd_com':
			predir = './Datasets/jd_com/'
			behs = ['view', 'read', 'cart', 'buy']

		elif args.data == 'jd_app':
			predir = './Datasets/jd_app/'
			behs = ['view', 'read', 'cart', 'buy']
   
		elif args.data == 'jd_com_micro':
			predir = './Datasets/jd_com_micro/'
			behs = ['view1','view2', 'view3', 'view4', 'view5', 'read1','read2', 'read3', 'cart', 'buy']
